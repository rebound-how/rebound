<template>
  ...
  >
    ...
    />
    <path fill="#0091ff" d="M128.1 249.2h11.2l-5.6-16.8z" />
    <path
      fill="#0091ff"
      d="M224 203H80c-2.2 0-4 1.8-4 4v73c0 2.2 1.8 4 4 4h144c2.2 0 4-1.8 4-4v-73c0-2.2-1.8-4-4-4zm-79.1 62.9-3.1-9.2h-16.2l-3.1 9.2h-9.8l16.7-44.8h8.6l16.8 44.8h-9.9zm46.4 0h-34.1v-5.4l22.1-31.9h-22.1v-7.5h33.6v5.3l-22.1 32.1h22.6v7.4z"
    />
  </svg>
</template>
