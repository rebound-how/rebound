<template>
  <ul class="tableList">
    ...
    <li v-if="headers !== undefined" class="tableList__row">
      <div class="tableList__cell">Headers</div>
      <div class="tableList__cell jsonString jsonString--envvar">
        {{ headers.var_name }}
      </div>
      <div class="tableList__cell">{{ headers.value }}</div>
    </li>
    <li v-else class="tableList__row">
      <div class="tableList__cell">Headers</div>
      <div class="tableList__cell"></div>
...
const headers = computed<Secret | undefined>(() => {
