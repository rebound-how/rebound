###############################################################################
#
# Induce packet loss into the call to the upstream server of our application
#
# Start the server:
#
...
# $ python evaluate_packet_loss_impact.py http://localhost:9090 https://jsonplaceholder.typicode.com
#
###############################################################################
import asyncio
import os
