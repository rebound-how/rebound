###############################################################################
#
# Induce blackhole into the call to the upstream server of our application
#
# Start the server:
#
...
# $ python evaluate_blackhole_impact.py http://localhost:9090 https://jsonplaceholder.typicode.com
#
#
###############################################################################
import asyncio
